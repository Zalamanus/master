...
public class HouseholdActivity extends AppCompatActivity {
    ...
    int choosenItem = -1;
    private static final String prefName = "HOUSEHOLD_PREFERENCES";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.householdList);
    ...
    public void onClickAdd(View view) {
        EditText editText = findViewById(R.id.editHousehold);
        ...
        if (!textToAdd.equals("")) {
            ...
            Toast toast = Toast.makeText(getBaseContext(),"Впишите хозтовар для добавления",Toast.LENGTH_LONG);
