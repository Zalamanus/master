...
public class ClothesActivity extends AppCompatActivity {
    ...
    int choosenItem = -1;
    private static final String prefName = "CLOTHES_PREFERENCES";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.clothesList);
    ...
    public void onClickAdd(View view) {
        EditText editText = findViewById(R.id.editClothes);
        ...
        if (!textToAdd.equals("")) {
            ...
            Toast toast = Toast.makeText(getBaseContext(),"Впишите одежду для добавления",Toast.LENGTH_LONG);
