...
public class ProductsActivity extends AppCompatActivity {
    ...
    int choosenItem = -1;
    private static final String prefName = "PRODUCTS_PREFERENCES";
    ...
    public void onClickAdd(View view) {
        EditText editText = findViewById(R.id.editProduct);
        ...
        if (!textToAdd.equals("")) {
            ...
            Toast toast = Toast.makeText(getBaseContext(),"Впишите продукт для добавления",Toast.LENGTH_LONG);
